...
<body>
    ...
    <div class="container mt-4 mb-4">
        <h1 class="text-center">7 Days Dubai Guided Tour Package</h1>
        <div class="row mt-5">
        ...
        <div class="row">
            <div class="col-md-8 mt-4 mb-4">
               <div class="container package-container bg-white">
                <h3>Overview</h3>
                <p class="text-secondary">Experience the best of Dubai with our exclusive 7-day guided tour. Explore iconic landmarks, enjoy comfortable accommodations, delicious meals, and expert-guided sightseeing tours.</p>
                    ...
                    <div class="accordion" id="itineraryAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#itineraryAccordion">
                                <div class="accordion-body">
                                    <p>✅ Meet & Greet at Dubai International Airport</p>
                                    <p>✅ Transfer to a 5-star hotel</p>
                                    <p>🍽️ Welcome dinner at a luxury restaurant</p>
                                    <p>🚅 Evening Dhow Cruise at Dubai Marina</p>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header text-dark" id="headingTwo">
                                ...
                                Day 2: Modern Dubai Exploration
                                </button>
                            </h2>
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#itineraryAccordion">
                                <div class="accordion-body">
                                    ...
                                    <p>✅ Guided tour of Burj Khalifa & Dubai Mall</p>
                                    <p>🍽️ Lunch at a local restaurant</p>
                                    <p>✅ Visit to Palm Jumeirah & Atlantis The Palm</p>
                                    <p>✅ Free time at JBR Beach</p>
                                    <p>🍽️ Dinner at a fine-dining restaurant</p>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header text-dark" id="headingThree">
                                ...
                                Day 3: Cultural Heritage & Old Dubai
                                </button>
                            </h2>
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#itineraryAccordion">
                                <div class="accordion-body">
                                    <p>🍽️ Breakfast at the hotel</p>
                                    <p>✅ Visit to Al Fahidi Historical District & Dubai Museum</p>
                                    <p>✅ Abra ride across Dubai Creek</p>
                                    <p>🍽️ Lunch at a traditional Emirati restaurant</p>
                                    <p>✅ Shopping at Gold & Spice Souks</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#itineraryAccordion">
                                <div class="accordion-body">
                                    <p>🍽️ Breakfast at the hotel</p>
                                    <p>✅ Free morning for relaxation or optional activities</p>
                                    <p>✅ Afternoon desert safari with dune bashing & camel ride</p>
                                    <p>🍽️ BBQ dinner with live entertainment at a desert camp</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#itineraryAccordion">
                                <div class="accordion-body">
                                    <p>🍽️ Breakfast at the hotel</p>
                                    <p>✅Transfer to Abu Dhabi (approx. 1.5 hours)</p>
                                    <p>✅ Visit to Sheikh Zayed Grand Mosque & Qasr Al Watan</p>
                                    <p>🍽️ Lunch at a luxury restaurant</p>
                                    <p>✅ Guided tour of Louvre Abu Dhabi</p>
                                    <p>🍽️ Return to Dubai, dinner at a local restaurant</p>
                                </div>
                            </div>
                        </div>
                        <!-- Day 6-->
                        <div class="accordion-item">
                            <h2 class="accordion-header text-dark" id="headingFour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                Day 6: Theme Park or Leisure Day
                                </button>
                            </h2>
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#itineraryAccordion">
                                <div class="accordion-body">
                                    <p>🍽️ Breakfast at the hotel</p>
                                    <p>✅ Full-day access to IMG Worlds of Adventure or Dubai Parks & Resorts (optional)</p>
                                    <p>✅ Free time for shopping at Mall of the Emirates or City Walk</p>
                                    <p>🍽️ Farewell dinner at a rooftop restaurant</p>
                                </div>
                            </div>
                        </div>
                        <!-- Day 7-->
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#itineraryAccordion">
                                <div class="accordion-body">
                                    <p>🍽️ Breakfast at the hotel, check-out</p>
                                    <p>✅ Free time for last-minute shopping</p>
                                    <p>✅ Transfer to Dubai International Airport for departure</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-8 mt-4 mb-4">
               <div class="container package-container bg-white">
                ...
                <p class="text-secondary">✅ <strong>Accommodation: </strong>Premium 5-star hotels with breakfast</p>
